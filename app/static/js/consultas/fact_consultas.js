...
const $tablaServiciosConsultaFact = document.getElementById("tablaServiciosConsultaFact");
...
const calcularTotalServicios = () => {
    let total = 0;
    for (let i = 1; i < $tablaServiciosConsultaFact.rows.length; i++){
        /* console.log($tablaServiciosConsulta.rows[i].cells[5].innerHTML); */
        let rowValue = $tablaServiciosConsultaFact.rows[i].cells[5].innerHTML;
